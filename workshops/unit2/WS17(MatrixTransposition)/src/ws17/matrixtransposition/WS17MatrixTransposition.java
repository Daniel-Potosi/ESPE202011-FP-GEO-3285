...
public class WS17MatrixTransposition {
    ...
    public static void main(String[] args) {
        ...
        t=new float[n][m];
         ...
         a=readMatrixElements(m, n, "A",scanner);
         b=readMatrixElements(m, n, "A",scanner);
    ...
    public static float[][] readMatrixElements(int m, int n, String matrixName, Scanner scanner) {
        float [][] matrix;
